...
# DynamoDB Table for Brand Guidelines
resource "aws_dynamodb_table" "brand_guidelines" {
  name         = "${var.project_name}-brand-guidelines"
  billing_mode = "PAY_PER_REQUEST"
  hash_key     = "guideline_id"
